...
GBAN_STATUS = CommandHandler("antispam", gbanstat, filters=Filters.chat_type.group)

GBAN_ENFORCER = MessageHandler(Filters.all & Filters.chat_type.group, enforce_gban)
